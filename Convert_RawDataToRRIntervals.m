function [t,rr,jqrs_ann,SQIjw, SQIjs, StartSQIwindows_jw, StartSQIwindows_js] = ...
    Convert_RawDataToRRIntervals(ECG_RawData ,HRVparams)
%   [t,rr,jqrs_ann,sqijw, StartIdxSQIwindows_jw] = ConvertRawDataToRRIntervals(ECG_RawData ,HRVparams)  
%
%	OVERVIEW:
...
%       SQIjw               :  Signal Quality Index values comparing jqrs and wqrsm 
